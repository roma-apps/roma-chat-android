...
import static tech.bigfig.romachat.data.api.RestApiKt.DOMAIN_HEADER;
import static tech.bigfig.romachat.data.api.RestApiKt.PLACEHOLDER_DOMAIN;
...
//            AccountEntity currentAccount = accountManager.getActiveAccount();
            ...
            String instanceHeader = originalRequest.header(DOMAIN_HEADER);
