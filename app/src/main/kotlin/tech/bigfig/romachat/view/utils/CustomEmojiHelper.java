...
public class CustomEmojiHelper {
    ...
    public static Spanned emojifyString(@NonNull String string, @Nullable List<Emoji> emojis, @NonNull final View view) {
        return emojifyText(new SpannedString(string), emojis, view);
    }
